module Git2
  ...
  @[Flags]
  enum GitCheckoutNotifyT : UInt32
  ...
  @[Flags]
  enum GitCheckoutStrategyT : UInt32
    GIT_CHECKOUT_NONE                    = 0
    GIT_CHECKOUT_SAFE
    GIT_CHECKOUT_FORCE
  ...
  @[Flags]
  enum GitDiffStatsFormatT : UInt32
  ...
  @[Flags]
  enum GitIndexAddOptionT : UInt32
  ...
  @[Flags]
  enum GitReferenceFormatT : UInt32
  ...
  @[Flags]
  enum GitRepositoryInitFlagT : UInt32
